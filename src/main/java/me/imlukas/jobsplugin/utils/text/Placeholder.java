package me.imlukas.jobsplugin.utils.text;

import lombok.AllArgsConstructor;
import lombok.Getter;
import lombok.RequiredArgsConstructor;
import lombok.Setter;
import me.imlukas.jobsplugin.utils.concurrent.FancyFuture;
import me.imlukas.jobsplugin.utils.concurrent.Reference;
...
public class Placeholder<T> {
    ...
    public Placeholder(String placeholder, FancyFuture<String> replacement) {
    ...
    public static List<Placeholder<Player>> asPlaceholderList(Map<String, Object> map) {
        ...
        for (Map.Entry<String, Object> entry : map.entrySet()) {
            ...
            if (value instanceof FancyFuture<?> future) {
